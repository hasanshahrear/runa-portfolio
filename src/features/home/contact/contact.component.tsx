...
import { ContactFormSchema, InitialValue } from "./form.config";
      ...
      <div className="container grid grid-cols-12 gap-4 lg:gap-10">
        <div className="col-span-12 lg:col-span-4 ">
          ...
          <div className="mt-12 space-y-6">
            <AddressCard
              icon={<FaMap size="30" className="text-link" />}
              title="Address"
              desc="Mirpur-2,Dhaka,Bangladesh"
            />
            <AddressCard
              icon={<FaEnvelope size="30" className="text-link" />}
              title="Email"
              desc="rejunahasan143@gmail.com"
            />
            <AddressCard
              icon={<FaPhoneAlt size="30" className="text-link" />}
              title="Phone"
              desc="01315028406"
            />
          </div>
